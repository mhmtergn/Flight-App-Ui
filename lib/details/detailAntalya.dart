...
class DetailAntalya extends StatefulWidget {
  var imgPath;

  DetailAntalya({this.imgPath});

  @override
  _DetailAntalyaState createState() => _DetailAntalyaState();
}

class _DetailAntalyaState extends State<DetailAntalya> {
  @override
